        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
          ...
          {isPopoverOpen && (
            ...
            >
              <div className="flex">
                {numberOfMonths === 2 && (
                  <div className="hidden md:flex flex-col gap-1 pr-4 text-left border-r border-background">
                    {dateRanges.map(({ label, start, end }) => (
                      <Button
                        ...
                        size="sm"
                        className={cn(
                          "justify-start hover:text-accent-foreground hover:bg-accent",
                          selectedRange === label &&
